            ...
            <div class="content">
                ...
                <article class="excerpt">
                    ...
                    <header>
                        ...
                        <h2>
                            <a target="_blank" href="#" >Mượn sách</a>
                    </header>
                    <div>
                            ...
                            $db = new DB_CONNECT();
                            echo "Mã sách<br>";
                            echo '<input name="masach" type="text" required>';
                            echo '<input name="them" type="submit" value="Mượn" class="button">';
                           ?>
                    </div>
                    </form>
                </article>
...
if(isset($_POST['them'])){
    ...
    $hoivien=$_SESSION['mahoivien'];
    $sql= "insert into muon_tra(ma_sach,ma_thu_thu,ma_doc_gia,ngay_muon) values($masach,$user,$hoivien,curdate())";

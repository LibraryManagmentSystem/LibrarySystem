            ...
            <div class="content">
                ...
                <article class="excerpt">
                    ...
                    <header>
                        ...
                        <h2>
                            <a target="_blank" href="#" >Phạt tiền quá hạn</a>
                    ...
                    <div id="quahan">
                            ...
                            $sql=("select *,(datediff(curdate(),mt.ngay_muon)-ds.thoi_han_muon) as quahan from muon_tra mt inner join sach s on mt.ma_sach=s.ma_sach
                            inner join dau_sach ds on ds.ma_dau_sach=s.ma_dau_sach
                            inner join doc_gia dg on dg.ma_doc_gia=mt.ma_doc_gia
                            where mt.ngay_tra=curdate() and dg.ma_doc_gia=$mahoivien");
                            ...
                            while ($row=mysql_fetch_array($result)){
                                if ($row['quahan']>0){
                                    ...
                                    <td><?php echo $row['quahan']; ?></td>
                                    <td><?php echo $row['quahan']*2000; ?></td>
                                    </tr>
                                    <?php
                                }
                            }
                    ...
                    <input class="submit" type="button" value="In ấn" onclick="PrintElem_phat('#quahan')" />
                    </form>
                </article>

            ...
            <div class="content">
                ...
                <article class="excerpt">
                    <header>
                        ...
                        <h2>
                            <a target="_blank" href="#" >Thêm bạn đọc.
                            </a>
                        </h2>
                    </header>
                    <div>
                            ...
                            <br/>
                            Mã độc giả<br />
                            <input type="text" id="txt1" name="ma_doc_gia" onkeyup="showHint(this.value)" /><p><span id="txtHint"></span></p> <br />
                            Họ tên<br />
...
if(isset($_POST['them'])){
        ...
        $_SESSION['ma_doc_gia_them'] = $ma_doc_gia;
        $ten = $_POST['ho_ten'];
        $so_dien_thoai = $_POST['so_dien_thoai'];
        $dia_chi = $_POST['dia_chi'];
        $email = $_POST['email'];
        //echo $ma_doc_gia;
        $sql = "insert into doc_gia(ma_doc_gia,ho_ten,so_dien_thoai,dia_chi,email,ngay_them, ma_nguoi_them)values($ma_doc_gia,'$ten','$so_dien_thoai','$dia_chi','$email',curdate(),$ma_thu_thu)";
        $query=mysql_query($sql);
         echo "<meta http-equiv=\"refresh\" content=\"0;URL=index.php\">"; 
}
if(isset($_POST['checkId'])){
    echo "<meta http-equiv=\"refresh\" content=\"0;URL=them_afterSearch.php\">";
}
?>
        ...
        <div >
            <form method="POST" >
                ...
                <select class="btn" name="choice">
                    <option value="1">Tất cả đầu sách</option>
                    <option value="2">Mã đầu sách</option>
                    <option value="3">Tên đầu sách</option>
            ...
            <div class="content">
                ...
                <article class="excerpt">
                    <header>
                        ...
                        <h2>
                            <a target="_blank" href="#" >Danh sách đầu sách
                            </a>
                        </h2>
                    </header>
                    ...
                    <div>
                        ...
                        $result = "select ds.*,s.*, count(*) as so_luong_con_lai
                                            from dau_sach ds
                                            left join sach s 
                                            on s.ma_dau_sach= ds.ma_dau_sach
                                ...
                                if(isset($_POST['choice']) && isset($_POST['s'])){
                                    ...
                                    if($selected == 2){
                                        $result = "select ds.*,s.*, count(*) as so_luong_con_lai
                                            ...
                                            on s.ma_dau_sach= ds.ma_dau_sach
                                            where s.isAvailable=1
                                            and ds.ma_dau_sach like '%$searchName%'
                                    ...
                                    if($selected == 3){
                                        $result = "select ds.*,s.*, count(*) as so_luong_con_lai
                                            ...
                                            on s.ma_dau_sach= ds.ma_dau_sach
                                            where s.isAvailable=1
                                            and ds.ten_dau_sach like '%$searchName%'
                                            group by s.ma_dau_sach";
                                    }
									if($selected == 4){
                                        /*$result = "select ds.*,s.*, count(*) as so_luong_con_lai
                                            ...
                                            on s.ma_dau_sach = ds.ma_dau_sach
                                            where s.isAvailable=1
                                            and s.ma_sach like '%$searchName%'c
                                            group by s.ma_dau_sach";*/
                                            $_SESSION['ma_sach_search'] = $_POST['s'];
                        ...
                        <form method="POST" onsubmit="return checkForm(this);">
                            <input type="submit" class="btn btn-primary" name="xoa4" value="Xóa chọn "  />
							<input type="submit" class="btn btn-primary" name="them" value="Thêm đầu sách"/>
                            <input type="submit" class="btn btn-primary" name="themsach" value="Thêm sách"/>
                            <input type="submit" class="btn btn-primary" name="sua" value="Sửa chọn" />
                            <br/>
                            <table style="width:100%">
                            <!--    <tr><input type="submit" class='xoaChon' name="xoa4" value="Xóa" /></td> -->
                                <tr>
                                    <th>Xóa</th>
                                    <th>STT</th>
                                    <th>Mã đầu sách</th>
                            ...
                            ?>
                                <tr>
                                <td><input name="cb[]" type="checkbox" value="<?php echo $row['ma_dau_sach']; ?>"></td>
                                <td><?php echo $i; ?></td> 
                                <td><?php echo $row['ma_dau_sach']; ?></td>

                                <td>

                                    <!-- <input name="radio[]" type="radio" value="<?php echo $row['so_luong_con_lai']; ?>"> -->
                                    

                                    <?php
                                        $link = 'http://localhost/LibrarySystem/QuanLySach/sach.php?id='.$row['ma_dau_sach'];
                                    ?>
                                    <a href =' 
                                    <?php echo $link; ?>
                                    '>

                                    <?php echo $row['ten_dau_sach']; ?>
                                    </a>
                                ...
                                <td>
                                    <!-- <input name="radio[]" type="radio" value="<?php echo $row['so_luong_con_lai']; ?>"> -->
                                    <?php
                                        $link = 'http://localhost/LibrarySystem/QuanLySach/update.php?id='.$row['ma_dau_sach'];
                                    ?>
                                    <a href =' 
                                    <?php echo $link; ?>
                                    '>
...
<?php
	if(isset($_POST['xoa4'])){
		...
		for ($i=0;$i<$count;$i++){
			$del_id=$cb[$i];
			$sql="delete from dau_sach where ma_dau_sach=$del_id";

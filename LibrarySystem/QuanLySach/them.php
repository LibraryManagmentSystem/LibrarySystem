            ...
            <div class="content">
                ...
                <article class="excerpt">
                    <header>
                        ...
                        <h2>
                            <a target="_blank" href="#" >Thêm đầu sách</a>
                        </h2>
						<div>
						...
						<form method="POST">
							Mã đầu sách<br />
							<input type="text" name="ma_dau_sach" /><br />
							Tên đầu sách<br />
							<input type="text" name="ten_dau_sach"/><br />
							Mã thể loại<br />
                            ...
                            <?php
                                ...
                                $result = @mysql_query("select * from the_loai;") or die(mysql_error());
                                echo "<select name='ma_the_loai'>";
                                if (mysql_num_rows($result) > 0) {
                                    while ($row = mysql_fetch_array($result)){

                                        echo " <option value=' ";

                                        echo $row['ma_the_loai'];
                            ...
                            <br>
							Thời hạn mượn<br />
							<input type="text" name="thoi_han_muon"/><br/>
							<input class="them1"type="submit" name="them1" value="Thêm"/>
						</form>
						</div>
                    </header>
				</article>
...
<?php
        ...
        $ten_dau_sach = $_POST['ten_dau_sach'];
        $ma_the_loai = $_POST['ma_the_loai'];
        $thoi_han_muon = $_POST['thoi_han_muon'];
        $ma_nguoi_them = $_SESSION['user_id'];
      
        $sql = "insert into dau_sach(ma_dau_sach, ten_dau_sach,ma_the_loai,thoi_han_muon,ma_nguoi_them)values($ma_dau_sach, '$ten_dau_sach', $ma_the_loai,$thoi_han_muon,$ma_nguoi_them )";
